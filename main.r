...
# Basic Map draw
ggplot(data = mymap) + geom_sf() + xlab("Longitude") + ylab("Latitude") + ggtitle("Algeria MAP") + geom_sf(color = "black", fill = "lightgreen")

# sting map
ggplot(data = map_and_data) + xlab("Longitude") + ylab("Latitude") + ggtitle("Algeria MAP") + geom_sf(aes(geometry = geometry, fill = sting)) + scale_fill_viridis_c(option = "plasma", trans="sqrt")
